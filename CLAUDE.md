...
- If something is unclear, consider if user can answer. Name what's confusing. Ask.

## 2. Simplicity First

**Minimum code that solves the problem. Nothing speculative.**

- No "flexibility" or "configurability" that wasn't requested. if there's potential, suggest it for future implementations.
...
- Don't "improve" unneeded adjacent code, comments, or formatting. Suggest the improvement for future implementations.
...
- Don't remove pre-existing dead code unless asked. Mention it for future consideration.
...
_(Record gotchas encountered during development here so fresh sessions can avoid them.)_
